...
# Generated: Fri Jul 28 17:52:18 2017
##################################################
...
class rx_ofdm_artur(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/jdmarques/hello', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/jdmarques/prefix/testeteste.txt', False)
        ...
        self.connect((self.analog_const_source_x_0_0, 0), (self.meu_qpsk_modulator_adapt_cb_0, 1))
        ...
        self.connect((self.meu_qpsk_demod_adapt_cb_0, 0), (self.blocks_repack_bits_bb_0_0, 0))
...
def main(top_block_cls=rx_ofdm_artur, options=None):
